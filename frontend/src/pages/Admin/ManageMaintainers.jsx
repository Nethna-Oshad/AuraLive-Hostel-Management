    ...
    <div className="flex min-h-screen bg-[#F8FAFC]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800">Maintainers (Pending Approval)</h2>
          
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100 text-gray-500 text-sm">
                  <th className="p-4 font-medium">Technician Name</th>
            ...
            {users.length === 0 && <div className="p-8 text-center text-gray-500">No maintainers registered yet.</div>}
          </div>
        </main>
      </div>
    </div>
